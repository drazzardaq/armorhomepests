...
import { Home, Users, Store, Trophy, Settings, User, Sun, Moon, LogOut } from "lucide-react";
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b border-neon-pink/30">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="w-6 h-6 border-2 border-neon-pink/20 border-t-neon-pink rounded-full animate-spin" />
          </div>
        </div>
      </nav>
    );
