<template>
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    >
      ...
      <h3 class="text-xl font-bold text-black mb-2">{{ advisor.name }}</h3>
      <p class="text-[#153695] font-medium mb-3">{{ advisor.title }}</p>
      <p class="text-gray-700 text-sm mb-4">{{ advisor.bio }}</p>
