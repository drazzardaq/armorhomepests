  ...
  <div class="venus-project-content w-full px-0 py-8 md:px-0 max-w-none bg-gradient-to-br from-white via-[#f7faff] to-[#eaf6ff] animate-fade-in text-black min-h-screen">
    ...
    <section class="mb-16 px-8 py-8 bg-white/80 backdrop-blur-lg rounded-xl shadow-lg animate-fade-in-up">
      <div class="flex flex-col md:flex-row gap-8 items-center">
        <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=600&q=80" alt="Relocation concept" class="rounded-2xl shadow-lg w-full max-w-xs object-cover mb-6 md:mb-0" loading="lazy" />
        <div class="flex-1">
          <h2 class="text-3xl font-bold mb-4 text-[#153695]">My Relocation & Collaboration Proposal</h2>
          <p class="mb-4 text-lg text-gray-800">Ready to relocate and join The Venus Project Network, contributing my skills and vision to help build a sustainable, ethical future. Open to direct contact, video calls, and project discussions. If you are part of The Venus Project, Fresco Foundation, or a like-minded network, please reach out directly.</p>
          <ul class="list-disc ml-8 text-lg mb-4 text-gray-700">
