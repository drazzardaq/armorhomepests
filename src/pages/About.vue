        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p class="text-gray-600 mb-6">
              At MyArmorHome, we're committed to providing exceptional pest control and security services to protect what matters most to you. Our veteran-led team brings years of experience and dedication to every job.
            </p>
